<?php
 ...
 class LoovService {
   ...
   public function payIn($data){
    ...
    $response = Http::withHeaders($this->headers)->post(env('LOOV_URL').'/payment/init', $body);
   ...
   public function mobileSoftPay($data){
    $body = [
        ...
        $response = Http::withHeaders($this->headers)->post(env('LOOV_URL').'/payment/payin/mobile', $body);
   ...
   public function payOut($data){
       ...
       $response = Http::withHeaders($this->headers)->post(env('LOOV_URL').'/payment/payout/mobile', $body);
   ...
   public function checkStatus(string $reference){
    ...
    $response = Http::withHeaders($this->headers)->post(env('LOOV_URL').'/payment/status/'.$reference);
